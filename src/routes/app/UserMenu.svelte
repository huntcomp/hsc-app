...
<div class="relative">
	...
	{#if dropdownVisible}
		<div
			...
			class="absolute right-0 top-12 z-10 w-36 divide-y divide-gray-100 rounded-md bg-white shadow"
			use:clickOutside
			on:clickoutside={hideDropdown}
		>
			<ul class="py-2 text-sm text-gray-700">
				<li>
					<button on:click={logout} class="block w-full px-4 py-2 hover:bg-gray-100"
						>Sign out</button
					>
				</li>
			</ul>
